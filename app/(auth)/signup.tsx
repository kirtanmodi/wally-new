    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.container}>
        <LinearGradient colors={["#6684ED", "#7E6EE8"]} style={styles.leftPanel}>
          ...
          <Text style={styles.appName}>Join Flow</Text>
          <Text style={styles.tagline}>Create an account to get started with task management and productivity</Text>
...
const styles = StyleSheet.create({
  ...
  // Left Panel (Signup welcome panel)
  leftPanel: {
